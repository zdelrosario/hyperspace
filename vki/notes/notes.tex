...
\publicationreference{
  STO-AVT-236 - Uncertainty Quantification in Computational Fluid Dynamics
}
...
\noindent \Cref{eq:pi-subspace} implies that the active subspace -- in the
...
\bibliographystyle{plain} \bibliography{bibtex_database}
