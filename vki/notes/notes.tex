...
lower-dimensional space. \Cref{eq:sine-bound} shows that a larger eigenvalue gap
...
we use the term \emph{intrinsic dimensionality} to describe this vague concept.
We have already seen various implementations of this idea:
