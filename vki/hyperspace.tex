...
\renewcommand\footnoterule{%
  \moveleft1cm\vbox{\textcolor{blue}{\rule{\paperwidth}{2pt}}\vskip 1mm}%
}
...
% -------------------------
\framepicv[1.0]{../images/as_contour0}{}
\framepicv[1.0]{../images/as_contour1}{}
